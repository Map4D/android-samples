...
public abstract class RoutingDemoModels {
    ...
    private static Alert createAlert(@NonNull CarContext carContext) {
        ...
        CarText subtitle =
                CarText.create("Subtitle");
        CarIcon icon = CarIcon.ALERT;

        CarText yesTitle = CarText.create("Yes");
        ...
        CarText noTitle = CarText.create("No title");
    ...
    public static Step getCurrentStep(@NonNull CarContext carContext) {
        ...
        CarIcon lanesImage =
                new CarIcon.Builder(IconCompat.createWithResource(carContext, vn.map4d.androidauto.demo.R.drawable.ic_zoom_in_24))
                        .build();
    ...
    public static Step getNextStep(@NonNull CarContext carContext) {
        ...
        String nextStepCue = "Next step cue";
        SpannableString nextStepCueWithImage = new SpannableString(nextStepCue);
        CarIconSpan highwaySign =
                CarIconSpan.create(
                        new CarIcon.Builder(
                                IconCompat.createWithResource(carContext, vn.map4d.androidauto.demo.R.drawable.ic_zoom_in_24))
                                .build(),
                        CarIconSpan.ALIGN_CENTER);
            ...
            builder.addAction(
                    new Action.Builder()
                            ...
                            .setIcon(new CarIcon.Builder(
                                    IconCompat.createWithResource(
                                            carContext,
                                      vn.map4d.androidauto.demo.R.drawable.ic_zoom_in_24))
                                    .build())
                            .build());
        }
        builder.addAction(
    ...
    public static TravelEstimate getTravelEstimate(@NonNull CarContext carContext) {
        ...
        return new TravelEstimate.Builder(
                ...
                .setTripText(CarText.create("Trip text"))
